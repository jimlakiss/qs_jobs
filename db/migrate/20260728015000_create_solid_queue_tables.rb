class CreateSolidQueueTables < ActiveRecord::Migration[8.1]
  ...
  def down
    remove_queue_foreign_key :solid_queue_scheduled_executions
    remove_queue_foreign_key :solid_queue_recurring_executions
    remove_queue_foreign_key :solid_queue_ready_executions
    remove_queue_foreign_key :solid_queue_failed_executions
    remove_queue_foreign_key :solid_queue_claimed_executions
    remove_queue_foreign_key :solid_queue_blocked_executions
  ...
  def remove_queue_foreign_key(table_name)
